...
func TestFullTypeName_type(t *testing.T) {
	...
	expected := "github.com/isometry/terraform-provider-aws/internal/framework/flex.emptyStruct"
...
func TestFullTypeName_mapTypedKeyPrimitiveValue(t *testing.T) {
	...
	expected := "map[github.com/isometry/terraform-provider-aws/internal/framework/flex.testEnum]string"
...
func TestFullTypeName_mapPrimitiveKeyTypedValue(t *testing.T) {
	...
	expected := "map[string]github.com/isometry/terraform-provider-aws/internal/framework/flex.testEnum"
