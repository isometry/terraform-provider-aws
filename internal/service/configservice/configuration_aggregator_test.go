...
import (
	...
	tfconfig "github.com/isometry/terraform-provider-aws/internal/service/configservice"
...
func TestAccConfigServiceConfigurationAggregator_account(t *testing.T) {
	...
	//Name is upper case on purpose to test https://github.com/isometry/terraform-provider-aws/issues/8432
