...
skaff: prereq-go ## Install skaff
	...
	cd skaff && $(GO_VER) install github.com/isometry/terraform-provider-aws/skaff
...
tfsdk2fw: prereq-go ## Install tfsdk2fw
	...
	cd tools/tfsdk2fw && $(GO_VER) install github.com/isometry/terraform-provider-aws/tools/tfsdk2fw
